...
# and https://github.com/liferlisiqi/Traffic-Sign-Classifier
...
class LeNet(nn.Module):
    def __init__(self, dataset="CIFAR10"):
        ...
        if dataset=="GTSRB":
            ...
            self.gate1 = GateLayer(6,6,[1, -1, 1, 1])
            self.conv2 = nn.Conv2d(6, 16, 5)
            self.gate2 = GateLayer(16,16,[1, -1, 1, 1])
            self.fc1   = nn.Linear(400, 120)
            self.gate3 = GateLayer(120,120,[1, -1])
            self.fc2   = nn.Linear(120, 80)
            self.gate4 = GateLayer(80,80,[1, -1])
